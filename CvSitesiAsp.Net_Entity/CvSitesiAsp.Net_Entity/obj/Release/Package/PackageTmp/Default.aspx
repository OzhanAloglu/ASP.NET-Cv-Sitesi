<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CvSitesiAsp.Net_Entity.Default" %>
...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            <img src="web/images/resmim.PNG" alt="news image" class="img-fluid navimg">
            <h1 class="top_hd mt-2"><a href="index.html">Özhan Aloğlu</a></h1>
    ...
    <div class="main">
                    ...
                    <p class="banp mx-auto mt-3">
                        ...
                        <asp:Repeater ID="Repeater1" runat="server">
                            ...
                            <ItemTemplate>
                                ...
                                <strong style="font-size: 30px;"><%#Eval("Bilgiler") %> </strong>
        ...
        <section class="slide-wrapper" id="about">
            ...
            <h4 class="main_hd">Software Developer
                <br>
            </h4>
